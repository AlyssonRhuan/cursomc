...
public class DbService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "alysson.salgado@gauge.com.br", "58150987606",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("12345"));
		Cliente cli2 = new Cliente(null, "Alysson Rhuan", "alyssonr.1993@gmail.com", "91499038615",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("12345"));
