...
public class DbService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "alysson.salgado@gauge.com.br", "58150987606", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("12345"));
		Cliente cli2 = new Cliente(null, "Alysson Rhuan", "alyssonr.1993@gmail.com", "91499038615", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("12345"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2105", null, "Centro", "12123123", cli2, c2);	
		...
		cli2.getTelefones().addAll(Arrays.asList("36231785", "99998888"));
